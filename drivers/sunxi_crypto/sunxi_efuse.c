...
static efuse_key_map_new_t g_key_info[] = {
	...
	EFUSE_DEF_ITEM(EFUSE_BROM_CONF_NAME, EFUSE_BROM_CONFIG, 32, 1, 1,
		       EFUSE_PRIVATE),
	EFUSE_DEF_ITEM(EFUSE_THM_SENSOR_NAME, EFUSE_THERMAL_SENSOR, 64, 2, 2,
		       EFUSE_RO),
	...
	EFUSE_DEF_ITEM(EFUSE_HDCP_HASH_NAME, EFUSE_HDCP_HASH, 128, 15, 15,
		       EFUSE_RO),
	EFUSE_DEF_ITEM(EFUSE_EK_HASH_NAME, EFUSE_EK_HASH, 128, 16, 16,
		       EFUSE_RO),
	...
	EFUSE_DEF_ITEM(EFUSE_KL_SCK0_NAME, EFUSE_SCK0, 512, 23, 23,
		       EFUSE_NACCESS),
	EFUSE_DEF_ITEM(EFUSE_KL_SCK1_NAME, EFUSE_SCK1, 512, 24, 24,
		       EFUSE_NACCESS),
#else
...
static efuse_key_map_new_t g_key_info[] = {
	EFUSE_DEF_ITEM(EFUSE_RSSK_NAME, EFUSE_RSSK, SID_RSSK_SIZE,
		       SCC_RSSK_DONTSHOW_FLAG, SCC_RSSK_BURNED_FLAG,
		       EFUSE_NACCESS),
	EFUSE_DEF_ITEM(EFUSE_SSK_NAME, EFUSE_SSK, SID_SSK_SIZE,
		       SCC_SSK_DONTSHOW_FLAG, SCC_SSK_BURNED_FLAG,
		       EFUSE_NACCESS),
	EFUSE_DEF_ITEM(EFUSE_ROTPK_NAME, EFUSE_ROTPK, SID_ROTPK_SIZE, -1,
		       SCC_ROTPK_BURNED_FLAG, EFUSE_RO),
	EFUSE_DEF_ITEM(EFUSE_HDCP_HASH_NAME, EFUSE_HDCP_HASH,
		       SID_HDCP_HASH_SIZE, -1, SCC_HDCP_HASH_BURNED_FLAG,
		       EFUSE_RO),
	EFUSE_DEF_ITEM("", 0, 0, 0, 0, EFUSE_PRIVATE),
};
...
static efuse_key_map_new_t g_key_info[] = {
	EFUSE_DEF_ITEM(EFUSE_CHIPID_NAME, 0x0, 128, -1, -1, EFUSE_RO),
	EFUSE_DEF_ITEM(EFUSE_THM_SENSOR_NAME, EFUSE_THERMAL_SENSOR, 32, -1, -1,
		       EFUSE_RO),
...
static efuse_key_map_new_t g_key_info[] = {
	...
	EFUSE_DEF_ITEM(EFUSE_HDCP_HASH_NAME, EFUSE_HDCP_HASH, 128, -1, 15,
		       EFUSE_RO),
	EFUSE_DEF_ITEM("", 0, 0, 0, 0, EFUSE_PRIVATE),
};
